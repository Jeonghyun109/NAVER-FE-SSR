  ...
  t.n = function (e) {
    ...
    var o = function o(e) {
      return a().createElement("div", null, a().createElement("div", {
        ...
        href: "#home"
      }, "통합"), a().createElement("a", {
        className: l,
        href: "#image"
      }, "이미지"), a().createElement("a", {
        className: l,
        href: "#knowledge"
      }, "지식백과"), a().createElement("a", {
        className: l,
        href: "#view"
      }, "VIEW"), a().createElement("a", {
        className: l,
        href: "#kin"
      }, "지식iN"), a().createElement("a", {
        className: l,
        href: "#influencer"
      }, "인플루언서"), a().createElement("a", {
        className: l,
        href: "#video"
      }, "동영상"), a().createElement("a", {
        className: l,
        href: "#shopping"
      }, "쇼핑"), a().createElement("a", {
        className: l,
        href: "#news"
      }, "뉴스"), a().createElement("a", {
        className: l,
        href: "#dictionary"
      }, "어학사전"), a().createElement("a", {
        className: l,
        href: "#map"
      }, "지도"), a().createElement("a", {
        className: l,
        href: "#book"
      }, "책"), a().createElement("a", {
        className: l,
        href: "#music"
      }, "뮤직"), a().createElement("a", {
        className: l,
        href: "#audio"
      }, "오디오클립")));
    },
      ...
      return a().createElement("div", {
      ...
      }, e.title.name), a().createElement("div", {
        ...
        className: N
      }, e.title.type), a().createElement("span", {
      ...
      return a().createElement("div", {
      ...
      }, "last" === e.subTap.mainTap.order && a().createElement("ul", {
        className: d
      }, a().createElement("li", {
        ...
        className: p
      }, e.subTap.mainTap.title)))), "first" === e.subTap.mainTap.order && a().createElement("ul", {
        className: d
      }, a().createElement("li", {
        className: f
      }, a().createElement("a", {
        ...
        className: p
      }, e.subTap.mainTap.title))), e.subTap.list.map(function (t, l) {
        return a().createElement("li", {
          className: f,
          key: l
        }, a().createElement("a", {
      ...
      }, e.similar.header.title), a().createElement("div", {
      ...
      return a().createElement("div", {
        ...
        className: k.h3
      }, e.common.together.header.title)), a().createElement("div", {
        ...
        }, e.sub_text), a().createElement("div", {
        ...
        className: k.span
      }, e.common.life.header.button), e.common.life.header.title)), a().createElement("div", {
        className: k.webtoonInfo
      }, a().createElement("ul", {
        className: k.webtoonList
        ...
        className: k.h3
      }, e.common["new"].header.title)), a().createElement("div", {
        className: k.webtoonInfo
      }, a().createElement("ul", {
        className: k.webtoonList
        ...
        className: k.h3
      }, e.common.weekly.header.title)), a().createElement("div", {
        className: k.webtoonInfo
      }, a().createElement("ul", {
        className: k.webtoonList
      ...
      }, e.basicInfo.title), a().createElement("div", {
      ...
      }, e.basicInfo.detail), a().createElement("a", {
      ...
      return a().createElement("div", {
        ...
        var r = 0 === l ? "xZczpMtN8MvR9jLG93jy" : l === e.common.imageList.length - 1 ? "OSm8GrXyUGa7J391Sgzb" : "QwboBBqRJnQT_wkHCK3f";
        return a().createElement("li", {
          key: l
        }, a().createElement("a", {
      ...
      }, e.common.title), a().createElement("div", {
      ...
      }, a().createElement("tbody", null, Object.keys(e.common.information).map(function (t, l) {
        return a().createElement("tr", {
          key: l
        }, a().createElement("td", {
          className: "KCbYgkcFRSdeQtiWSrdc",
          key: l
        }, t), e.common.information[t].link ? a().createElement("td", {
          key: "td" + l,
          className: B
        }, a().createElement("a", {
          href: e.common.information[t].url,
          className: "FKBKlt3skRLtUnTzv1Dc"
        }, e.common.information[t].detail)) : a().createElement(a().Fragment, null, a().createElement("td", {
          key: "td" + l,
          className: B
      ...
      }, e.common.descriptionText), a().createElement("div", {
      ...
      }, "동물" === e.mainCard.title.type && a().createElement(S, {
        common: e.mainCard.common
      }), "문화재" === e.mainCard.title.type && a().createElement(F, {
        common: e.mainCard.common
      }), "웹툰" === e.mainCard.title.type && a().createElement(x, {
        common: e.mainCard.common
      }), "웹툰" === e.mainCard.title.type && a().createElement(w, {
        similar: e.mainCard.similar
      }), "웹툰" !== e.mainCard.title.type && a().createElement(y, {
        similar: e.mainCard.similar
      })));
    },
        L = "lTxjECTPG4UBmvZNHf3c",
        K = function K(e) {
      return a().createElement(a().Fragment, null, a().createElement("a", {
        href: e.blog.href,
      ...
      }, e.blog.title), "true" === e.blog.influencer && a().createElement(a().Fragment, null, a().createElement("div", {
        className: L
      }), a().createElement("div", {
        className: "I0xNw6ThnzgKwWBLMReQ"
      }, "인플루언서")), a().createElement("div", {
        className: L
      }), a().createElement("div", {
        className: "CPTRr9N6TiKd_rBNc5OG"
      }, e.blog.time)), a().createElement("div", {
      ...
      return a().createElement(a().Fragment, null, a().createElement("a", {
      ...
      }, e.body.title), a().createElement("div", {
      ...
      }, e.body.detail)), a().createElement("a", {
        href: e.body.href,
        ...
        M = function M(e) {
      return a().createElement(a().Fragment, null, 0 !== e.tags.list.length && a().createElement("div", {
        ...
        _ = function _(e) {
      return a().createElement(a().Fragment, null, 0 !== Object.keys(e.link).length && a().createElement("div", {
      ...
      }, e.totalWrap.article.title), a().createElement("div", {
        className: "XBTWlOCtipqwm6i_EMCR"
      }), a().createElement("div", {
        className: "IbRTgo5LUgUUgLKPB9bw"
      }, e.totalWrap.article.time)), a().createElement("div", {
      ...
      }, e.totalWrap.text.title), a().createElement("div", {
      ...
      }, e.totalWrap.text.detail)), "" !== e.totalWrap.text.src && a().createElement("a", {
        href: e.totalWrap.text.href,
      ...
      return a().createElement("div", {
        ...
        className: z.h2
      }, e.news.header.title)), a().createElement("ul", {
        className: z.ul
      ...
      return a().createElement("div", {
      ...
      }, "Gold" === e.influencer.thumbnail.highlighted && a().createElement(a().Fragment, null, a().createElement("a", {
      ...
      }))), "Silver" === e.influencer.thumbnail.highlighted && a().createElement(a().Fragment, null, a().createElement("a", {
        href: e.influencer.thumbnail.url
      }, a().createElement("img", {
        src: e.influencer.thumbnail.image,
        className: V,
        ...
        className: "fas fa-crown"
      }))), "Bronze" === e.influencer.thumbnail.highlighted && a().createElement(a().Fragment, null, a().createElement("a", {
        href: e.influencer.thumbnail.url
      }, a().createElement("img", {
        src: e.influencer.thumbnail.image,
        className: V,
        ...
        className: "fas fa-crown"
      }))), "None" === e.influencer.thumbnail.highlighted && a().createElement(a().Fragment, null, a().createElement("a", {
        href: e.influencer.thumbnail.url
      }, a().createElement("img", {
        src: e.influencer.thumbnail.image,
        className: V,
    ...
    var D = function D(e) {
      return a().createElement("div", {
        ...
        return a().createElement("div", {
          key: l
        }, 0 === l ? a().createElement("div", null, "Blog" === t.type && a().createElement("i", {
          className: "fas fa-stop",
          style: {
            marginRight: "5px"
          }
        }), "YouTube" === t.type && a().createElement("i", {
          className: "fab fa-youtube",
          style: {
            marginRight: "5px"
          }
        }), "Company" === t.type && a().createElement("i", {
          className: "fas fa-briefcase",
          style: {
            marginRight: "5px"
          }
        }), a().createElement("b", null, t.title), a().createElement(J(), {
          sx: {
          ...
          key: l
        }, t.value), l !== e.influencer.keywords.length - 1 && a().createElement(J(), {
          sx: {
            color: e.colorScheme.border,
            fontSize: "4pt",
            marginBottom: "2.5pt",
      ...
      return a().createElement("div", {
        ...
        var r = 0 === l ? "yBc434N4AZpEGjKdRvQP" : l === e.images.length - 1 ? "SBejqJ92woj7wqUE9gVf" : "ICyQYcXvLgmj6ZjglyW1";
        return a().createElement("li", {
          key: l
        }, a().createElement("a", {
        ...
        Y = function Y(e) {
      return a().createElement(a().Fragment, null, e.influencers.map(function (t) {
        return a().createElement("div", {
        ...
        }, t.title), a().createElement("span", {
          className: "LO1GoketnEUwBz9Mr8_3"
        }, t.subtitles.fans)), a().createElement("div", {
          className: "cMKcWwLmE_N0wyVLSK2S"
        }, a().createElement("span", {
          style: {
            color: e.colorScheme.main
          }
        }, t.subtitles.title), a().createElement("span", {
          className: "ZlaamkcByLlI7EX3kZe8"
        }), t.subtitles.expertise))), a().createElement(D, {
        ...
        }, t.description.title), a().createElement("a", {
          href: t.link,
          className: "q61BE74JeDObiTgSciAv"
        }, t.description.descriptionText), a().createElement("div", {
          className: "v3wYRc0kzx0B0PINmNTU"
        }, t.description.date)), a().createElement("a", {
        ...
        }), a().createElement("b", null, t.title), t.description.moreText, a().createElement("span", {
    ...
    var te = t(860),
        ...
        ie = te.Router(),
        oe = te();
    oe.use(re()), oe.use(le.urlencoded({
      extended: !1
    })), oe.use(le.json()), oe.use("/", ie), ie.post("/", function (e, t) {
      var l;
      t.send('\n    <!DOCTYPE html>\n    <html lang="ko">\n        <head>\n        <link rel="stylesheet" href="style.css">\n<script src=\'https://kit.fontawesome.com/a076d05399.js\' crossorigin=\'anonymous\'><\/script>\n        <script\n          src="https://use.fontawesome.com/releases/v5.15.4/js/all.js"\n          data-auto-a11y="true"\n        ><\/script>\n        </head>\n        <body>\n            '.concat(ce.renderToString((l = e.body, a().createElement("div", {
        ...
        return a().createElement("div", {
          key: t
        }, "mainCard" === e && a().createElement(R, {
          mainCard: l[0].mainCard
        }), "influencers" === e && a().createElement(ae, {
          influencer: l[0].influencer
        }), "view" === e && a().createElement(P, {
          view: l[0].view
        }), "news" === e && a().createElement(G, {
          news: l[0].news
        }));
      }))))), "\n        </body>\n    </html>\n"));
