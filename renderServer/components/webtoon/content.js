                  ...
                  return (
                      <li className={styles.webtoonElem} key={idx}>
                          ...
                          <a className={styles.webtoonLink}>
                              <imag src={webtoonInfo["image"]} className={styles.webtoonImg} />
                          </a>
                          <div class="title_box">
                            <strong class="name type_ell_2">
                              <a href={webtoonInfo["url"]}>{webtoonInfo["title"]}</a>
                            </strong>
                            <span class="cartoonist">{webtoonInfo["sub-title"]}</span>
                            <div class="bottom_info">
                              <span class="divide_line"></span>
                              <span class="preference">선호도 {webtoonInfo["preference"]}%</span>
                            </div>
                          </div>
                      </li>
                  );
