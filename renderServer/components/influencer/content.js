        ...
        return (
          <div className={styles.contentBody}>
              ...
              <tbody>
                <tr>
                  <td rowSpan={2} className={styles.headerThumbnail}>
                    <img
                      src={influencer["thumbnail"]["image"]}
                      className={styles.influencerThumbnail}
                      alt="thumbnail"
                    ></img>
                  </td>
                  <td className={styles.headerDetail}>
                    <span className={styles.title}>{influencer["title"]}</span>{" "}
                    &nbsp;{" "}
            ...
            <div className={styles.keywords}>
              <b>{influencer["keywords"][0]["title"]}</b>{" "}
              {influencer["keywords"][1]["value"]}{" "}
              {influencer["keywords"][2]["value"]}{" "}
              {influencer["keywords"][3]["value"]}
            </div>
